    ...
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
        ...
        >
          ...
          <span className="text-sm sm:text-base">Pridať jazyk</span>
        </Button>
      </div>
          ...
          {languages.map((lang) => (
            ...
            >
              <div className="flex items-start sm:items-center space-x-3 sm:space-x-4 flex-1 min-w-0">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 dark:bg-primary-900/30 rounded-lg flex items-center justify-center text-xl sm:text-2xl shrink-0">
                  {lang.flag || '🌐'}
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-2 gap-0.5">
                    ...
                    {lang.nativeName && (
                      <>
                        ...
                        <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate">{lang.nativeName}</span>
                      </>
                    )}
                  </div>
                  <div className="flex flex-wrap items-center gap-x-2 gap-y-1 mt-1">
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                      Kód: <span className="font-mono bg-gray-100 dark:bg-gray-700 px-1.5 sm:px-2 py-0.5 rounded text-xs">{lang.code}</span>
                    </p>
              ...
              <div className="flex items-center justify-between sm:justify-end space-x-2 sm:space-x-3">
                ...
                <div className="flex items-center space-x-1 sm:space-x-2">
                  <button
                    ...
                    className="p-1.5 sm:p-2 text-gray-600 dark:text-gray-400 hover:text-yellow-600 dark:hover:text-yellow-400 transition-colors"
